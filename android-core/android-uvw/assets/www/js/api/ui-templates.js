class UICommons {
 appNotificationsHeader_view_icons(){
  return (new UICommons().appNotificationsHeader_view_tasks()
    +'<div class="container-fluid" style="height:51px;background-color:#172a33;padding-left:15px;padding-right:15px;">'
	+'<div class="row">'
 ...
 appStatisticsHeader_view(){
   return ('<div class="container-fluid" style="height:60px;background-color:#273340;color:#fff;padding-top:10px;padding-bottom:10px;">'
    +'<div class="row">'
    +'<div align="left" class="col-xs-4">'
    +'<div><i class="fa fa-money"></i>:&nbsp;<i class="fa fa-inr"></i>&nbsp;<b>10000</b></div>'
    +'<div><span class="label label-blackGrey-o"><i class="fa fa-university"></i>&nbsp;<b>Go Bank</b></span></div>'
    +'</div>'
    +'<div align="left" class="col-xs-4">'
    +'<div class="row">'
    +'<div class="col-xs-2 pad0"><i class="fa fa-heart" style="color:#f7584c;"></i>&nbsp;</div>'
    +'<div class="col-xs-7 pad0">'
    +'<div class="progress">'
	+'<div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" '
	+'style="width:70%;background-color:#4caf50;">'
	+'<span class="sr-only">70% Complete</span>'
	+'</div>'
	+'</div>'
	+'</div>'
	+'<div align="center" class="col-xs-2 pad0"><i class="fa fa-plus-circle" style="color:#f7584c;"></i>&nbsp;</div>'
	+'</div>'
	+'<div class="row">'
	+'<div class="col-xs-2 pad0"><i class="fa font-yellow fa-cutlery"></i>&nbsp;</div>'
	+'<div class="col-xs-7 pad0">'
	+'<div class="progress">'
	+'<div class="progress-bar" role="progressbar" aria-valuenow="70" '
	+'aria-valuemin="0" aria-valuemax="100" style="width:70%;background-color:#4caf50;">'
	+'<span class="sr-only">70% Complete</span>'
	+'</div>'
	+'</div>'
	+'</div>'
	+'<div align="center" class="col-xs-2 pad0"><i class="fa font-yellow fa-plus-circle"></i>&nbsp;</div>'
	+'</div>'
    +'</div>'
 ...
 appFooter_view(){
  return ('<div class="footer" style="height:65px;background-color:#273340;overflow-x:scroll;overflow-y:hidden;">'
	...
	+'<a href="app-game-dashboard.html" class="font-yellow">'
...
class UIHome {
 ...
 offersNewsNeighborhood(){
   return (new UIHome().watchNews_view_modal()+'<div class="container-fluid">'
	...
	+'<div align="center" class="list-group-item border0 bg-pink-full" style="height:97px;padding-left:0px;padding-right:0px;">'
	...
	+'<div class="col-xs-4 pad0">'
	+'<div class="list-group borderRad0">'
	+'<div align="center" class="list-group-item border0 bg-skyBlue-full" style="height:97px;padding-left:0px;padding-right:0px;" '
	...
	+'<div class="col-xs-4 pad0">'
	+'<div class="list-group borderRad0">'
	+'<div id="apphome_onn_seeNeighborhood" align="center" class="list-group-item border0 bg-yellow-full" '
